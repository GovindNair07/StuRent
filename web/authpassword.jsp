...
<div  class="formtheme">
<h2  cssStyle="">AUTH PASSWORD SETTING FORM</h2>
<%@taglib prefix="s"  uri="/struts-tags" %>

<s:form action="authpwdcode.action">
    <s:textfield label="Id"  name="id"/>
    <s:password label="Old Password"  name="pwd"/>
    <s:password label="New Password"  name="npwd"/>
    <s:password label="Confirm New Password"  name="cnpwd"/>
